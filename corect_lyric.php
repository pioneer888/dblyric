				...
				<div id="contact_form">
                   <table width="685" border="0">
                      <tr>
                        ...
                        <td width="250" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">nama artis</font></div></td>
                         <?php if ($id==1) { ?>
                        <td width="75" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">action</font></div></td>
                        <?php } ?>
                      </tr>
                      <?php
                        $nomor = 1;
                                                                     
                        $sql = "SELECT * FROM lyric ORDER by views DESC";
                        $hasil=mysql_query($sql,$koneksi);
                        while($rows = mysql_fetch_array($hasil)){ 
                        $singer = mysql_fetch_array(mysql_query("SELECT nama FROM artis WHERE id_artis='".$rows['id_artis']."'"));
                      ...
                      <tr>
                       ...
                       <td valign="top"><div align="center"><font face="verdana" size="2"><a href="view.php?id=<?php echo $rows['id_lyric'] ?>"><?php echo $rows['judul'] ?></a></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $singer['nama']; ?></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><a href="cor_form.php?id_lyric=<?php echo $rows['id_lyric']  ?>"><input type="submit" value="correct" class="submit_btn float_r"/></td></a>
                       </tr>
                      <?php }?>
                     </table>
                </div>
