      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            ...
            <h1>Add Lyric</h1>
                ...
                <div id="contact_form">
                   <form method="post" name="contact" action="proses/edit.php">
                        <?php
                        ...
                        $album = mysql_fetch_array(mysql_query("SELECT nama FROM album WHERE id_album=".$lyric['id_album']));
                        ?>
                        
                        <label for="subject">Nama Artis:</label> <input type="text" name="nama_artis" value="<?php echo $singer['nama'] ?>" readonly="readonly" class="input_field" />
                        <div class="cleaner h10"></div>
                        
						<label for="subject">Nama Member:</label> <input type="text" name="nama_member" value="<?php echo $user['username'] ?>" readonly="readonly" class="input_field" />
						<div class="cleaner h10"></div>
        
                        <label for="subject">Nama Album:</label> <input type="text" name="nama_album" value="<?php echo $album['nama'] ?>" readonly="readonly" class="input_field" />
                        <div class="cleaner h10"></div>

                        <label for="subject">Judul:</label> <input type="text" name="judul" value="<?php echo $lyric['judul'] ?>" readonly="readonly" class="input_field" />
                        <div class="cleaner h10"></div>

                        <label for="text">Lyric:</label> <textarea id="text" name="lyric" rows="0" cols="0" class="required"><?php echo $lyric['lyric'] ?></textarea>
                        <div class="cleaner h10"></div>
