...
<div id="templatemo_wrapper">
  ...
  <div id="templatemo_middle" class="carousel"> 
    ...
    <div class="backgrounds"> 
      <div class="item item_1"> <img src="images/product/Demi3.jpg" alt="Slider 01" /> 
      </div>
      <!-- /item -->
      <div class="item item_2"> <img src="images/product/Demi.jpg" alt="Slider 02" /> 
      </div>
      <!-- /item -->
      <div class="item item_3"> <img src="images/product/Demi2.jpg" alt="Slider 03" /> 
      </div>
      <!-- /item -->
    </div>
    <!-- /backgrounds -->
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div class="content"> 
         ...
         <div id="content3" class="float_r">
                <a href="productdetail.html"><img src="images/product/d.jpg" alt="Image 04" /></a>
                <h3>Demi Lovato</h3>
                <p class="product_price"> ALBUM DEMI</p>
