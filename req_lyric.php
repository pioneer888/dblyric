    ...
    <div id="templatemo_main">
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            <h1>REQ Lyric</h1>
				<h4>REQ Lyric Here!</h4>
                <div id="contact_form">
                   <table width="685" border="0">
                      <tr>
                        <td width="10" bgcolor="#CCCCCC"><div align="center">#</div></td>
                        <td width="250" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">Judul</font></div></td>
                        <td width="250" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">nama</font></div></td>
                        <td width="75" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">Tanggal</font></div></td>
                        <?php if ($id==1) { ?>
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM request ORDER by tanggal DESC";
                        $hasil=mysql_query($sql,$koneksi);
                        while($record=mysql_fetch_array($hasil)){ 
                      ?>
                      <tr>
                       <td valign="top">&nbsp;<font face="verdana" size="2"><?php echo $nomor++; ?></font></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2"><a href="<?php echo 'view_req.php?id_req='.$record['id_req']; ?>"><?php echo $record['judul']; ?></a></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $record['nama']; ?></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $record['tanggal']; ?></font></div></td>
                       <?php if ($id==1) { ?>
                       <td valign="top"><div align="center"><a href="<?php echo 'proses/del.php?id_del='.$record['id_req']; ?>"><img src="images/delete.png" alt="" width="22" height="22"/></a></div></td>
                       <?php } ?>
                      </tr>
                      <?php } if ($record = "") { ?>
                      ...
                      <tr>
                       <td></td><td></td><td></td>
                       <td><a href="req_form.php"><input type="submit" value="Request" class="submit_btn float_r"/></td></a>
                      </tr>
                    </table>
                </div>
            </div>
