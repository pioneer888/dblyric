    ...
    <div id="templatemo_main">
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            <h1>List Lyric</h1>
                <div id="contact_form">
                    <form method="POST" action="../proses/delete_artis.php">
                    <table width="685" border="0">
                      <tr>
                        <td width="10" bgcolor="#CCCCCC"><div align="center">#</div></td>
                        <td width="200" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">Nama Artis</font></div></td>
                        <td width="200" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">Tahun Terbentuk</font></div></td>
                        <td width="175" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">Tempat Terbentuk</font></div></td>
                        <?php if ($id==1) { ?>
                      ...
                      <tr>
                       ...
                       <td valign="top"><div align="center"><font face="verdana" size="2"><a href="../profil.php?id=<?php echo $record['id_artis']?>"><?php echo $record['nama']; ?></a></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $record['tahun']; ?></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $record['tempat_lahir']; ?></font></div></td>
                       <?php if ($id==1) { ?>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="white"><input  type="checkbox" name="del[]" value="<?php echo $record['id_lyric']?>"/></font></div></td>
                      <?php } ?>
                      </tr>
                      <?php } if ($record = "") { ?>
                      ...
                      <tr>
                       ...
                       <td><input type="submit" value="Delete" class="submit_btn float_r"/></td></a>
                      </tr>
                      <?php } ?>
                    </table>
                    </form>
