    ...
    <div id="templatemo_main">
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            <h1>View Member</h1>
                <div id="contact_form">
                    <form method="POST" action="../proses/delete_member.php">
                    <table width="685" border="0">
                      <tr>
                        <td width="10" bgcolor="#CCCCCC"><div align="center">#</div></td>
                        <td width="200" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">Username</font></div></td>
                        <td width="200" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">Email</font></div></td>
                        <td width="175" bgcolor="#CCCCCC"><div align="center"><font face="verdana" size="2">Tanggal Daftar</font></div></td>
                        <?php if ($id==1) { ?>
                      ...
                      <tr>
                       ...
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $record['username']; ?></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $record['email']; ?></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $record['tanggal']; ?></font></div></td>
                       <?php if ($id==1) { ?>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="white"><input  type="checkbox" name="del[]" value="<?php echo $record['id_member']?>"/></font></div></td>
                      <?php } ?>
                      </tr>
                      <?php } if ($record = "") { ?>
