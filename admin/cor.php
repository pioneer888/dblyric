				...
				<div id="contact_form">
                   <table width="685" border="0">
                      ...
                      <?php
                        ...
                        $hasil=mysql_query($sql,$koneksi);
                        while($rows = mysql_fetch_array($hasil)){ 
                        $judul = mysql_fetch_array(mysql_query("SELECT judul FROM lyric WHERE id_lyric='".$rows['id_lyric']."'"));
                        
                      ?>
                      <tr>
                       <td valign="top">&nbsp;<font face="verdana" size="2"><?php echo $nomor++; ?></font></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2"><?php echo $judul['judul'] ?></a></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><?php echo $singer['nama']; ?></font></div></td>
                       <td valign="top"><div align="center"><font face="verdana" size="2" color="black"><a href="view_cor.php?id_lyric=<?php echo $rows['id_lyric']  ?>"><input type="submit" value="view" class="submit_btn float_r"/></td></a>
                       </tr>
                      <?php }?>
                     </table>
                </div>
