    ...
    <div id="templatemo_main">
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            ...
            <h1>Add Album</h1>
				<h4>Add Album Here!</h4>
                <div id="contact_form">
                   <form method="post" name="album" action="../proses/add_album.php" onSubmit="return validasi()">

                        <label for="subject">Nama Artis:</label> <input type="text" name="nama_artis" class="required input_field" />
                        <div class="cleaner h10"></div>
                        
						<label for="subject">Nama Album:</label> <input type="text" name="nama" class="input_field" />
						<div class="cleaner h10"></div>
        
                        <label for="subject">Tahun:</label> <input type="text" name="tahun" class="input_field" />
...
Copyright© 2099 <a href="https://www.facebook.com/prastyo.adi.108">Achmad Sayyid</a> | 2015 By Sistem Informasi ITS. All Rights Reserved</a>
    ...
    var x=document.forms['album']['tahun'].value;
    var y=document.forms['album']['tahun'].value.length;
