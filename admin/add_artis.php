...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            ...
            <h1>Add Artis</h1>
				<h4>Add Artis Here!</h4>
                <div id="contact_form">
                   <form method="post" name="artis" action="../proses/tambah_artis.php" onSubmit="return validasi()">
                        
                        <label for="author">Name:</label> <input type="text" name="nama" class="required input_field" />
                        <div class="cleaner h10"></div>

                        <label for="subject">Tahun:</label> <input type="text" name="tanggal" class="required input_field" />
                        <div class="cleaner h10"></div>
                        
						<label for="subject">Tempat Lahir:</label> <input type="text" name="tempat" class="input_field" />
						<div class="cleaner h10"></div>
        
                        <label for="subject">Genre:</label> <input type="text" name="genre" class="input_field" />
    ...
    <div id="templatemo_footer">
    	<p>
			<a href="../index.php">Home</a> | <a href="products.html">Products</a> | <a href="about.html">About</a> | <a href="faqs.html">FAQs</a> | <a href="checkout.html">Checkout</a> | <a href="contact.html">Contact</a>
		</p>
...
<script>
    ...
    var x=document.forms['artis']['tanggal'].value;
    var y=document.forms['artis']['tanggal'].value.length;
