    ...
    <div id="templatemo_main">
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            ...
            <h1>Correct Lyric</h1>
				<h4>Correct Lyric Here!</h4>
                <div id="contact_form">
                   <form method="post" name="contact" action="proses/accept_cor.php">
                        <?php 
                        $a="SELECT * FROM lyric WHERE id_lyric='$id_lyric'";
                        $hasil = mysql_query($a, $koneksi);
                        $liric = mysql_fetch_array($hasil);
                        ?>
                        <label for="subject">Judul:</label> <input type="text" name="judul" value="<?php echo $liric['judul'] ?>" readonly="readonly"class="input_field" />
                        <div class="cleaner h10"></div>

                        <?php if ($id!==""){ ?>
                        
						<label for="subject">Nama Member:</label> <input type="text" name="nama" value="<?php echo $record['username'] ?>" readonly="readonly" class="input_field" />
						<div class="cleaner h10"></div>

                        <?php }else { ?>

                        <label for="subject">Nama:</label> <input type="text" name="nama" class="input_field" />
                        <div class="cleaner h10"></div>

                        <?php } ?>
                        
                        <label for="text">lyric:</label> <textarea id="text" name="lyric" rows="0" cols="0" class="required" style="width: 400px; height: 600px;">"<?php echo $liric['lyric'] ?>"</textarea>
                        <div class="cleaner h10"></div>
