    ...
    <div id="templatemo_main">
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            <?php
            $artis = mysql_fetch_array(mysql_query("SELECT * FROM artis WHERE id_artis=$id_profil"));
            $album = mysql_query("SELECT * FROM album WHERE id_artis=".$artis['id_artis']);
            ?>
            <h1>Profil : <?php echo  $artis['nama']; ?></h1>
            <div class="content_half float_l">
                <font size="3" color="black">
                <span>Nama Artis : <?php echo  $artis['nama']; ?><br></span>
                <div class="cleaner h10"></div>
                <span>Tahun Debut : <?php echo  $artis['tahun']; ?><br></span>
                <div class="cleaner h10"></div>
                <span>Tempat Lahir : <?php echo  $artis['tempat_lahir']; ?><br></span>
                <div class="cleaner h10"></div>
                <span>Genre : <?php echo  $artis['genre']; ?><br></span>
                <div class="cleaner h10"></div>
                </font>
            </div>
            <div class="content_half float_r">
                <font size="3" color="black">
                <?php
                while($rows = mysql_fetch_array($album)){ 
                ?>
                
                <span>Nama Album : <?php echo  $rows['nama']; ?><br></span>
                <div class="cleaner h10"></div>
                <span>Tahun : <?php echo  $rows['tahun']; ?><br></span>
                <div class="cleaner h10"></div>
