...
$views=mysql_fetch_array(mysql_query("SELECT views FROM lyric WHERE id_lyric=$id_lyric"));
$dilihat = $views['views'] + 1;
$sql2 = "UPDATE lyric SET views='$dilihat' WHERE id_lyric='$id_lyric'";
    ...
    <div id="templatemo_main">
      ...
      <div class="sidebar_box"><span class="bottom"></span> 
        ...
        <div id="content" class="float_r">
            ...
            $user = mysql_fetch_array(mysql_query("SELECT username,id_member FROM member WHERE id_member=".$lyric['id_member']));
            ?>
            <h1><a href='profil.php?id=<?php echo $lyric['id_artis']?>'><?php echo  $singer['nama']. "</a> - " .$lyric['judul']; ?></h1>
            <?php if ($id == 1 || $id == $user['id_member']) { ?>
            <a href="proses/delete.php?del=<?php echo $id_lyric ?>"><input type="submit" value="Delete" class="submit_btn float_r"/></a>
            <a href="edit_lyric.php?id=<?php echo $id_lyric ?>"><input type="submit" value="Edit" class="submit_btn float_r"/></a>
            <?php } ?>
            <div class="content_half float_l">
                ...
                <font color="black">
                    <pre><?php echo $lyric['lyric']; ?></pre><br>
                    --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    <?php include("tambahkomentar.php"); ?>
                </font>
